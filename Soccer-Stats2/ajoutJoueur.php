...
?>
                ...
                ?>       
                    ...
                    <div class="input-field">
                        <input name="matchJoues" type="text" placeholder="Match Jouer" required>                  
                    </div>
                     <div class="input-field">
                        <input name="but" type="text" placeholder="But" required>                  
                    </div>
                     <div class="input-field">
                        <input name="passD" type="text" placeholder="Passe décisive" required>
                    </div>
