...
?>
                ...
                ?>       
                    ...
                    <div class="input-field">
                        <input name="matchJoues" type="number" placeholder="Nombre de Match Jouer" required>
                    </div>  
                    <div class="input-field">
                        <input name="buts" type="number" placeholder="Nombre de Buts" required>
                    </div> 
                    <div class="input-field">
                        <input name="victoire" type="number" placeholder="Nombre de Victoire" required>
                    </div>
                    <div class="input-field">
                        <input name="nul" type="number" placeholder="Nombre de nul" required>                  
                    </div>
                     <div class="input-field">
                        <input name="defaite" type="number" placeholder="Nombre de defaite" required>                  
                    </div>
                     <div class="input-field">
                        <input name="points" type="number" placeholder="Nombre de Points" required>
                    </div>
